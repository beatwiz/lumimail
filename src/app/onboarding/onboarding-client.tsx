	...
	return (
		...
		>
			<div className="space-y-5">
				{step === 1 && (
					<>
						<p className="rounded-2xl bg-[var(--accent-muted)] px-4 py-3 text-sm leading-6 text-[var(--ink)]">
							{t("dnsInfo")}
						</p>
						...
						<div className="space-y-2">
							...
							<div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2">
								<Input
									...
									className="min-w-0"
								/>
								<span className="max-w-36 truncate text-sm font-medium text-[var(--ink-muted)]">@{hostname}</span>
							</div>
						</div>
						<Button
							onClick={addMailbox}
